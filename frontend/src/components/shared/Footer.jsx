      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0 text-white">
            <h2 className="text-xl font-bold">Job <span className='text-primary'>Portal</span></h2>
            <p className="text-sm text-gray-400">© 2026 Your Company. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/in/satyam-gupta-b2b69936a" className="hover:text-gray-400" aria-label="LinkedIn">
